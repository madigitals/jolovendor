...
class AppConstants {
  static const String appName = 'Jolo Vendor';
  ...
  static const String baseUrl = 'https://admin.jolojolo.com';
  ...
  //  LanguageModel(imageUrl: Images.spanish, languageName: 'Spanish', countryCode: 'ES', languageCode: 'es'),// LanguageModel(imageUrl: Images.bangla, languageName: 'Bengali', countryCode: 'BN', languageCode: 'bn'),
  ];
}
